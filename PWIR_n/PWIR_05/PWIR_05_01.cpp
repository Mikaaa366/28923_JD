...
int main(){
    ...
    printf("Calculated parallel way with num_threads 2 in %lu miliseconds\n",
    std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count());
    ...
    printf("Calculated parallel way with num_threads 4 in %lu miliseconds\n",
    std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count());
    ...
    printf("Calculated parallel way with num_threads 5 in %lu miliseconds\n",
    std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count());
    ...
    printf("Calculated parallel way with num_threads 6 in %lu miliseconds\n",
    std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count());
    ...
    printf("Calculated parallel way with num_threads 8 in %lu miliseconds\n",
    std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count());
